...
var budgetController = (function() {
    ...
    var addItem = function(type, des, val) {
        ...
        // Create new ID based on last ID in current allItems[type] array
        ...
        // Return the new element (for use later on)
        return newItem;
    };
    ...
    var calculateBudget = function() {
        ...
        // 1. Calulate total income and expenses
        calulateTotal('exp');
        calulateTotal('inc');
...
var controller = (function(budgetCtrl, UICtrl) {
    ...
    var updatePercentages = function() {
        ...
        // 3. Update the user UI with new percentages
    ...
    var ctrlAddItem = function() {
        ...
        if (input.description !== "" && !isNaN(input.value) && input.value > 0) {
            ...
            // 6. Calculatr and update percentages
            updatePercentages();
    ...
    var ctrlDeleteItem = function(event) {
        ...
        if (itemId) {
            ...
            // 4. Calculatr and update percentages
            updatePercentages();
